 21.4 44.4 34.8 67.7 43.1 2.7-36.9 2.3-49.9 2.6-68.5-36.4 2.5-57.4 8.3-67 12.7M1040.9 378.6v13.2c0 2.9-2.3 5.2-5.2 5.2h-62.9c0 3.3.1 6.2.1 8.9 0 19.5-.8 35.4-2.7 53.3-.3 2.7-2.5 4.7-5.1 4.7h-13.6c-1.4 0-2.7-.6-3.6-1.6s-1.4-2.4-1.2-3.8c1.9-17.8 2.8-33.5 2.8-52.6 0-2.8 0-5.7-.1-8.9h-62.2c-2.9 0-5.2-2.3-5.2-5.2v-13.2c0-2.9 2.3-5.2 5.2-5.2h61.3c-1.3-21.5-3.9-42.2-8.1-63.2-.2-1.3.1-2.6.9-3.6s2-1.6 3.3-1.6h14.7c2.3 0 4.2 1.6 4.7 3.9 4.1 21.7 6.7 42.8 8 64.5h63.7c2.8 0 5.2 2.4 5.2 5.2"/><defs><radialGradient id="dp-a" cx="942.524" cy="279.896" r="760.124" fx="942.524" fy="279.896" gradientUnits="userSpaceOnUse"><stop offset=".007" stop-color="#021192"/><stop offset=".03" stop-color="#021096"/><stop offset=".057" stop-color="#010cb4"/><stop offset=".084" stop-color="#0008ce"/><stop offset=".111" stop-color="#0006d7"/><stop offset=".138" stop-color="#0004e1"/><stop offset=".165" stop-color="#0001fa"/><stop offset=".191" stop-color="#0000fe"/><stop offset=".216" stop-color="#0f1eff"/><stop offset="1" stop-color="#0ff" stop-opacity="0"/></radialGradient></defs><path fill="url(#dp-a)" d="M955.3 273.9c-32.5-79.9-87.4-148-158.8-197C723.4 26.8 637.7.3 548.7.3 401.5.3 264.9 73.4 183.4 195.9c-.9 1.3-1.1 3-.6 4.5.5 1.6 1.7 2.7 3.2 3.2l11.4 3.9c.7.2 1.4.3 2 .3 2.1 0 4.1-1.1 5.3-2.8 37.4-55 88-100.7 146.4-132.3 60.3-32.6 128.6-49.9 197.5-49.9 83.3 0 163.6 24.6 232.4 71 67.1 45.3 119.2 108.6 150.7 182.9.9 2.2 3.1 3.7 5.5 3.7h13.6c1.6 0 3.1-.8 3.9-2.1 1-1.3 1.2-2.9.6-4.4"/></svg>',
  wowtv:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1046.162 300"><defs><linearGradient id="wt-a" x1="3.4" x2="258.96" y1="42.19" y2="42.19" gradientTransform="translate(-13.867 -22.51)scale(4.09277)" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#0c2426"/><stop offset=".18" stop-color="#0b2d2f"/><stop offset=".48" stop-color="#084447"/><stop offset=".86" stop-color="#02696f"/><stop offset="1" stop-color="#00797f"/></linearGradient></defs><path d="M89.68 292.224c28.24 0 41.338-15.962 52.388-38.063L192 154.297l25.375 91.27c9.823 35.197 22.92 46.657 47.885 46.657 24.966 0 40.928-8.186 54.843-42.156l37.654-92.496C359.803 243.929 422.013 300 506.734 300c84.72 0 142.428-55.252 154.297-125.648l13.097 73.67c5.73 30.696 20.055 44.202 44.611 44.202 24.557 0 38.882-9.823 51.16-32.333l57.299-105.594 22.51 94.543c6.958 28.65 19.645 43.384 45.02 43.384s37.654-10.232 48.704-31.924l96.59-188.267a52.4 52.4 0 0 0 6.139-24.966c0-22.101-17.19-39.29-42.565-39.29s-37.654 12.278-47.476 33.97l-45.84 98.226-24.556-96.59c-5.32-21.691-17.599-35.607-41.746-35.607-15.553 0-31.105 4.502-45.43 31.515l-52.387 101.091-18.008-96.18c-4.093-25.375-22.101-36.426-43.384-36.426a42.156 42.156 0 0 0-43.792 43.384 77.8 77.8 0 0 0 1.227 14.324l1.638 8.186C622.15 32.742 577.539 0 516.556 0c-41.746 0-89.222 15.962-118.69 54.843a79 79 0 0 0 .41-9.823c-.41-21.282-14.325-37.244-39.7-37.244s-36.835 11.05-45.84 33.97L272.627 146.93 246.024 44.202c-5.73-21.282-16.78-36.426-40.927-36.426-24.148 0-36.017 7.777-48.295 34.789l-45.839 105.184-22.92-103.547c-5.73-25.375-23.738-36.426-45.43-36.426-21.691 0-43.792 17.6-42.564 43.384a39.3 39.3 0 0 0 1.637 11.05l40.518 180.082c6.14 26.194 15.962 49.932 47.477 49.932M443.706 152.66c0-39.29 29.468-70.395 66.303-70.395s66.303 27.83 66.303 68.349c0 40.518-27.422 67.121-66.303 67.121s-66.303-28.65-66.303-65.075" style="fill:url(#wt-a)"/></svg>',
  // no verified official logo path data available -- simple generic placeholder icon
  // (color block + initials) instead of guessing at exact brand artwork
  ds3cheatsheet:
...
// ist fertig geladen (readyState 4), aber pausiert -- ohne Klick auf der Seite laesst Chrome
// kein Autoplay mit Ton zu. Aus der Uebersicht heraus gab es den Klick, deshalb lief es dort.
// Ein play() per Skript startet hoechstens stumm; deshalb ein grosser Play-Knopf ueber dem
// Player (Daniels Wunsch): Sein Klick ist die Interaktion, die Chrome verlangt, und die Folge
// laeuft mit Ton. Gewartet wird zwei Takte, damit TOGGO selbst starten kann. Der Knopf
// verschwindet, sobald das Video laeuft -- egal, wodurch.
function toggo_playKnopf() {
  insertCSS(
    `
    .cu-toggo-play {
      position: fixed;
    ...
    .cu-toggo-play:hover { background: rgba(0, 0, 0, 0.8); }
    .cu-toggo-play::after {
      content: "";
      margin-left: 10px;
      border-style: solid;
  ...
  repeatIfCondition(
    () => {
      const video = [...queryAll("video")].find(
        (v) => cu_isRealVideo(v) && v.paused && v.readyState >= 3 && v.currentTime < 1,
      );
      if (knopf && (!video || knopf.video !== video)) {
        knopf.remove();
        knopf = null;
      }
      if (!video || navigator.userActivation?.hasBeenActive || knopf) {
        wartend = null;
        return;
      }
      if (wartend !== video) {
      ...
      knopf.className = "cu-toggo-play";
      knopf.title = "Abspielen";
      knopf.video = video;
      const r = video.getBoundingClientRect();
      knopf.style.left = `${r.left + r.width / 2}px`;
      knopf.style.top = `${r.top + r.height / 2}px`;
